...
function finalBackgroundColor(e){var bg;do{bg=e.css('color');if(colorMatters(bg)){return bg;}
...
elem.css('color',printColor(c));step=step+1;setTimeout(glowFunction,timeoutstep);}else{elem.css('color',ocol);elem.attr('glowing',0);}}
var elem=$(this);if(elem.attr('glowing')==1){return;}
elem.attr('glowing',1);var ocol=$(elem).css('color');var dstc=parseColor(finalBackgroundColor(elem));if(!dstc){return;}
