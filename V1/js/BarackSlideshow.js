...
var BarackSlideshow = new Class({
  ...
  show: function(index) {
    ...
    if(index == 0)
	{
		previous = this.imagesitems.length - 1;
		document.getElementById("small_button").style.visibility = "visible";
		document.getElementById("large_button").style.visibility = "hidden";
	}  
	else
	{
		previous = index - 1;
			document.getElementById("small_button").style.visibility = "hidden";
			document.getElementById("large_button").style.visibility = "visible";
	}
	var previous_image = this.imagesitems[previous];
